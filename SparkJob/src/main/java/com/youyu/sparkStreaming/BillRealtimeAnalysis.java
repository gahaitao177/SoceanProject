 ...
 */
public class BillRealtimeAnalysis {
    public static void main(String[] args) {
        SparkConf conf = new SparkConf().setAppName("BillRealtimeAnalysis").setMaster("local[2]");
        ...
        kafkaParams.put("group.id", "spark_streaming_group_id");
        ...
        for (int i = 0; i < countChildren; i++) {
            ...
            //在foreachRDD中更新zookeeper上的offsets:
            sessionDetailDStream.foreachRDD(new VoidFunction<JavaRDD<BillImportRecord>>() {
                ...
                public void call(JavaRDD<BillImportRecord> javaRDD) throws Exception {
                    ...
                    SQLContext sqlContext = new SQLContext(javaRDD.context());
                    ...
                    if (null != offsets) {
                        ...
                        for (OffsetRange o : offsets) {
                            ...
                            //ZkUtils.updatePersistentPath(zkPath, String.valueOf(o.untilOffset()), zkClient);
