package com.youyu.hbase.online;
...
public class SparkStreamingFromFlumeToHBaseExample {
    ...
    public static void main(String[] args) {
        if (args.length == 0) {
            System.err
                    .println("Usage: SparkStreamingFromFlumeToHBaseWindowingExample {master} {host} {port} {table} " +
                            "{columnFamily} {windowInSeconds} {slideInSeconds");
            System.exit(1);
        }
