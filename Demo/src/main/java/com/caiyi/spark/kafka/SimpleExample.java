...
public class SimpleExample {
    ...
    public static void main(String[] args) throws Exception {
        ...
        seeds.add("192.168.1.71");
        //端口
        int port = Integer.parseInt("9164");

        example.run(maxReads, topic, partition, seeds, port);

    }

    public void run(long a_maxReads, String a_topic, int a_partition, List<String> a_seedBrokers, int a_port) throws
            Exception {
